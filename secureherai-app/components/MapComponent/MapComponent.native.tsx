...
export interface MapLocation {
  ...
  mode?: string; // Added for directions travel mode
  name?: string; // Added for display name in directions
}
...
// Interface for exposed map methods
...
const MapComponent = forwardRef<MapComponentRef, MapComponentProps>(
  (
    ...
    useImperativeHandle(ref, () => ({
      ...
      setCamera: (camera: any) => mapRef.current?.setCamera(camera),
    }));
    ...
    return (
      ...
      >
        ...
        {/* Render children (like MapViewDirections) */}
        {children}
      </MapView>
    );
  }
